...
int main(int argc, char **argv)
{
	...
	dsp_n_delay = std::stoi(argv[6]);
	dsp_n_delay_cycles = (std::stoi(argv[7]) + 1);
	dsp_feedback_pol_alternate = (std::stoi(argv[8]) & 0x00000001);
	dsp_cycle_div_inc_one = (std::stoi(argv[9]) & 0x00000001);
