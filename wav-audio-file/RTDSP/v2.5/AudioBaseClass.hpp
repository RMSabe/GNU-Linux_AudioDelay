...
class AudioBaseClass {
	 ...
	 *
	 * (Pointer) "p_" prefix means the invalid value for this variable is 0 (NULL). Example: void *ptr = NULL;
	...
	protected:
		...
		const size_t BUFFEROUT_N_SEGMENTS = 2u;
		...
		void *p_bufferin = NULL;
		void *p_bufferout = NULL;
