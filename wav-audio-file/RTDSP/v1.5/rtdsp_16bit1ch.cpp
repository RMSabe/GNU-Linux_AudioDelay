...
#define BUFFEROUTPUT_SIZE_BYTES (2U*BUFFEROUTPUT_SIZE_SAMPLES)
...
void buffer_malloc(void)
{
	...
	buffer_output_0 = (short*) malloc(BUFFEROUTPUT_SIZE_BYTES);
	buffer_output_1 = (short*) malloc(BUFFEROUTPUT_SIZE_BYTES);
	buffer_output_2 = (short*) malloc(BUFFEROUTPUT_SIZE_BYTES);
	buffer_output_3 = (short*) malloc(BUFFEROUTPUT_SIZE_BYTES);
