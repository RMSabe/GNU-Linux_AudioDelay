...
AudioRTDSP_i24::AudioRTDSP_i24(const audiortdsp_pb_params_t *p_pbparams) : AudioRTDSP(p_pbparams)
{
}
...
bool AudioRTDSP_i24::audio_hw_init(void)
{
	...
	if(n_ret < 0)
	{
		...
		this->err_msg = "AudioRTDSP_i24::audio_hw_init: Error: snd_pcm_open failed.";
		return false;
	}
	...
	{
		this->audio_hw_deinit();
		this->err_msg = "AudioRTDSP_i24::audio_hw_init: Error: snd_pcm_hw_params_malloc failed.";
		return false;
	}
	...
	if(n_ret < 0)
	{
		...
		this->audio_hw_deinit();
		this->err_msg = "AudioRTDSP_i24::audio_hw_init: Error: snd_pcm_hw_params_any failed.";
		return false;
	}
	...
	if(n_ret < 0)
	{
		snd_pcm_hw_params_free(p_hwparams);
		this->audio_hw_deinit();
		this->err_msg = "AudioRTDSP_i24::audio_hw_init: Error: snd_pcm_hw_params_set_rate_resample failed.";
		return false;
	}
	...
	if(n_ret < 0)
	{
		snd_pcm_hw_params_free(p_hwparams);
		this->audio_hw_deinit();
		this->err_msg = "AudioRTDSP_i24::audio_hw_init: Error: snd_pcm_hw_params_set_access failed.";
		return false;
	}
	...
	if(n_ret < 0)
	{
		snd_pcm_hw_params_free(p_hwparams);
		this->audio_hw_deinit();
		this->err_msg = "AudioRTDSP_i24::audio_hw_init: Error: snd_pcm_hw_params_set_format failed.";
		return false;
	}
	...
	if(n_ret < 0)
	{
		snd_pcm_hw_params_free(p_hwparams);
		this->audio_hw_deinit();
		this->err_msg = "AudioRTDSP_i24::audio_hw_init: Error: snd_pcm_hw_params_set_channels failed.";
		return false;
	}
	...
	if(n_ret < 0)
	{
		snd_pcm_hw_params_free(p_hwparams);
		this->audio_hw_deinit();
		this->err_msg = "AudioRTDSP_i24::audio_hw_init: Error: snd_pcm_hw_params_set_rate failed.";
		return false;
	}
	...
	if(n_ret < 0)
	{
		...
		if(n_ret < 0)
		{
			snd_pcm_hw_params_free(p_hwparams);
			this->audio_hw_deinit();
			this->err_msg = "AudioRTDSP_i24::audio_hw_init: Error: snd_pcm_hw_params_set_buffer_size_near failed.";
			return false;
		}
	}
	...
	if(n_ret < 0)
	{
		snd_pcm_hw_params_free(p_hwparams);
		this->audio_hw_deinit();
		this->err_msg = "AudioRTDSP_i24::audio_hw_init: Error: snd_pcm_hw_params_set_period_size failed.";
		return false;
	}
	...
	if(n_ret < 0)
	{
		snd_pcm_hw_params_free(p_hwparams);
		this->audio_hw_deinit();
		this->err_msg = "AudioRTDSP_i24::audio_hw_init: Error: snd_pcm_hw_params failed.";
		return false;
	}
...
void AudioRTDSP_i24::buffer_load(void)
{
	...
	p_currin_seg = (int32_t*) (this->pp_bufferinput_segments[this->bufferin_nseg_curr]);
...
{
	int32_t *p_currin_seg = NULL;
	int32_t *p_loadout_seg = NULL;
	int32_t *p_bufferin = NULL;
	...
	p_currin_seg = (int32_t*) (this->pp_bufferinput_segments[this->bufferin_nseg_curr]);
	p_loadout_seg = (int32_t*) (this->pp_bufferoutput_segments[this->bufferout_nseg_load]);
	p_bufferin = (int32_t*) (this->p_bufferinput);
